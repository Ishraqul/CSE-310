<%-- 
    Document   : show_branches
    Created on : May 16, 2021, 11:39:15 AM
    Author     : Asus
--%>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <form action="FetchBranchData" method="POST" class="text-center">
        <input type="submit" value="Get All the Branch Records" >
    </form>
